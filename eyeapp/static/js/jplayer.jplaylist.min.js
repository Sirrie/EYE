...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
		...
		_createItemHandlers: function() {
            ...
            $(self.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass).off("click","a." + this.options.playlistOptions.itemClass).on("click","a." + this.options.playlistOptions.itemClass, function() {
            ...
            $(self.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass).off("click","a." + this.options.playlistOptions.itemClass).on("click","a." + this.options.playlistOptions.itemClass, function() {
                var index = $(this).parent().parent().index();
                self.remove(index);
                $(this).blur();
                return false;
